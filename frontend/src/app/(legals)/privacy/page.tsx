  ...
  return (
    <div>
      <div id="content" className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
        ...
        >
          <h2
            id="name-und-anschrift-des-verantwortlichen"
          ...
          <div className="space-y-2">
            ...
            <p className="italic space-y-1">
              ...
              <span>E-Mail: info@flowgrids.deanthropomorphization</span>
            </p>
          </div>
        </section>
        ...
        <section id="outline-container-formulare" className="mb-8">
          ...
          >
            ...
            <p className="mb-2">
              ...
              ggf. IV.) genannten Daten hinaus personenbezogene Daten
            ...
            <p className="mb-2">
              ...
              Art. 6 Abs. 1 lit. e) DSGVO. Ist eine abweichende Rechtsgrundlage
              einschlägig, werden Sie, ebenso wie über den Zweck der
              Verarbeitung sowie über die Löschfristen, direkt auf den
              Formularseiten informiert.
            </p>
            <p>
              ...
              Fall werden die mit der E-Mail übermittelten personenbezogenen
              Daten der Nutzerin/des Nutzers gespeichert.
            </p>
          </div>
        </section>
        ...
        >
          ...
          >
            ...
            <p>
              ...
              Wir gehen davon aus, dass Sie mit der Kommunikation auf diesem
              Wege einverstanden sind und diese so stattfinden kann.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Wenn Sie uns eine E-Mail senden, so werden der Inhalt dieser
              E-Mail und Ihre E-Mail-Adresse ausschließlich für die
              Korrespondenz mit Ihnen und für die Verarbeitung der Konversation
              verwendet. Es erfolgt in diesem Zusammenhang keine Weitergabe der
              Daten an Dritte.
            </p>
          </div>
          ...
          >
            ...
            <p>
              ...
              Zweckes ihrer Erhebung nicht mehr erforderlich sind. Für
          ...
          >
            ...
            <p>
              ...
              werden. Wir können in der Regel auch Ihre Identität nicht
              überprüfen und wissen nicht, wer sich hinter einer E-Mail-Adresse
              verbirgt. Eine rechtssichere Kommunikation durch einfache
              E-Mail-Schreiben ist daher nicht gewährleistet. Wir setzen - wie
              ...
              und löschen. E-Mails, die schädigende Programme („Viren“)
              enthalten, werden von uns automatisch abgewiesen oder gelöscht,
              soweit diese von unseren technischen Einrichtungen erkannt werden.
              Wenn Sie schutzwürdige Nachrichten an uns senden wollen, empfehlen
              wir dringend, diese zu verschlüsseln und zu signieren, um eine
              unbefugte Kenntnisnahme und Verfälschung auf dem Übertragungsweg
              zu verhindern oder die Nachricht auf konventionellem Postweg an
              uns zu senden.
            </p>
          </div>
        </section>
        ...
        <section id="outline-container-orge50496e" className="mb-8">
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              entspricht unserem berechtigten Interesse im Sinne des Art. 6 Abs.
              1 S. 1 lit. f DSGVO, selbst keinen Server in unseren
            ...
            <p>
              ...
              Aktivitäten, bei denen GitHub personenbezogene Daten von
        ...
        <section
          id="outline-container-rechte-der-betroffenen-personen"
          className="mb-8"
        >
          <h2
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              Sie haben das Recht, von der Hochschule Konstanz Auskunft über die
              zu Ihrer Person gespeicherten personenbezogenen Daten gemäß Art.
              15 DSGVO zu erhalten und/oder unrichtig gespeicherte
              personenbezogene Daten gemäß Art. 16 DSGVO berichtigen zu lassen.
            </li>
            <li>
              Sie haben darüber hinaus das Recht auf Löschung (Art. 17 DSGVO)
              oder auf Einschränkung der Verarbeitung (Art. 18 DSGVO) oder ein
              Widerspruchsrecht gegen die Verarbeitung (Art. 21 DSGVO) sowie ein
              Recht auf Datenübertragbarkeit (Art. 20 DSGVO). Ausgenommen sind
              Datenspeicherungen, die zum Betrieb der Internetseite technisch
              notwendig sind. Die Erfassung der Daten zur Bereitstellung der
              Website und die Speicherung der Daten in Logfiles ist für den
              Betrieb der Internetseite zwingend erforderlich.
            </li>
            <li>
              Erfolgt der Widerspruch im Rahmen eines Vertragsverhältnisses kann
              dies zur Folge haben, dass eine Vertragsdurchführung nicht mehr
              möglich ist.
            </li>
            <li>Einwilligungen können jederzeit widerrufen werden ...</li>
            <li>
              Beruht die Verarbeitung der personenbezogenen Daten auf einer
              Einwilligung kann diese jederzeit widerrufen werden. Die
              Rechtmäßigkeit der Verarbeitung bleibt bis zum Widerruf unberührt.
            </li>
            <li>
              ...
              datenschutzrechtlichen Vorschriften verstößt (Art. 77 DSGVO).
            </li>
            <li>
